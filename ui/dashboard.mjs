...
import { EventTail, createState, applyEvents, pruneSessionHistory } from '../lib/event-fold.mjs';
...
/**
 * Every lane/row falls back to worktree when there is no lane
 * (applyEvents' key in lib/event-fold.mjs, renderSnapshot's `·` placeholder) — worktree is the
